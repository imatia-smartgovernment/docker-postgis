...
echo "host    all             all             172.16.0.0/12               md5" >> /etc/postgresql/9.5/main/pg_hba.conf
echo "host    all             all             10.0.0.0/8                 md5" >> /etc/postgresql/9.5/main/pg_hba.conf
echo "host    all             all             192.168.0.0/16                 md5" >> /etc/postgresql/9.5/main/pg_hba.conf
echo "host    all             all             169.254.0.0/16                 md5" >> /etc/postgresql/9.5/main/pg_hba.conf
